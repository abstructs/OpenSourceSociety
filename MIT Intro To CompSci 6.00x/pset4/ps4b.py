...
"""
Similar to ps4a.py except players are allowed
to have the computer play for them. The computer will
always choose the answer that will reward the most points.
"""
    ...
    while True:
        ...
        if userChoice == 'r':
            if not bool(hand):
                ...
                while not(userChoice == 'u' or userChoice == 'c'):
