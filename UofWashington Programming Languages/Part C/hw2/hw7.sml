...
fun eval_prog (e,env) =
	...
	(case exp of
	     NoPoints => NoPoints
	   | Point(r1, r2) => Point(r1 + deltaX, r2 + deltaY)
	   | Line(m, b) => Line(m, b + (deltaY - (m * deltaX)))
	   | VerticalLine(r) => VerticalLine(r + deltaX)
	   | LineSegment(r1, r2, r3, r4) => LineSegment(r1, r2, r3 + deltaX, r4 + deltaY)
	   | Var s => eval_prog(Shift(deltaX, deltaY, eval_prog(Var(s), env)), env)
