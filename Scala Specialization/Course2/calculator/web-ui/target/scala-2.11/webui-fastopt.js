...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      var x1$2 = references.get__O__s_Option(name);
      var x$2 = $m_s_None$();
      if ((x$2 === x1$2)) {
        return (NaN)
      } else if ($is_s_Some(x1$2)) {
        var x2$2 = $as_s_Some(x1$2);
        var v = $as_Lcalculator_Signal(x2$2.x$2);
        var temp$expr = $as_Lcalculator_Expr(v.apply__O());
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  var jsx$1 = $uD(b.apply__O());
  var x = $uD(delta.apply__O());
  var pos = (((-jsx$1) + $uD($g.Math.sqrt(x))) / (2 * $uD(a.apply__O())));
  var jsx$2 = $uD(b.apply__O());
  var x$1 = $uD(delta.apply__O());
  var neg = (((-jsx$2) - $uD($g.Math.sqrt(x$1))) / (2 * $uD(a.apply__O())));
  if (($uD(delta.apply__O()) < 0)) {
    ...
    $m_Lcalculator_Signal$();
    var expr$1 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(pos$1, neg$1) {
      return (function() {
        var array = [pos$1, neg$1];
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(m) {
  var jsx$1 = m.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, m$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr($as_Lcalculator_Signal(m$1.$$und2$f).apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, m));
  return new $c_T2().init___O__O(jsx$1, new $c_Lcalculator_Signal().init___F0(expr))
});
