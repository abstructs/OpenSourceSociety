...
if you've played those. Letters are dealt to players, who 
then construct one or more words out of their letters. Each 
valid word receives a score, based on the length of the word 
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while not calculateHandlen(handCopy) <= 0:
        # Display the hand
        ...
        if not isValidWord(userWord, handCopy, wordList):
        ...
        print('" ' + userWord + ' " earned ' + str(wordScore) + '  points. Total:  ' + str(score) + '  points', end="\n\n")
        
        # Update the hand 
        handCopy = updateHand(handCopy, userWord)
